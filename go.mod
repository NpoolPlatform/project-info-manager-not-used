module github.com/NpoolPlatform/project-info-manager
...
require (
	...
	github.com/NpoolPlatform/libent-cruder v0.0.0-20220516071113-a13e447a48a9
	github.com/NpoolPlatform/message v0.0.0-20220601074315-f4da34280ea9
