...
func (cdq *CoinDescriptionQuery) sqlAll(ctx context.Context) ([]*CoinDescription, error) {
	var (
...
func (cdgb *CoinDescriptionGroupBy) ScanX(ctx context.Context, v interface{}) {
...
func (cdgb *CoinDescriptionGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cdgb.fields) > 1 {
		return nil, errors.New("ent: CoinDescriptionGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cdgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cdgb *CoinDescriptionGroupBy) StringsX(ctx context.Context) []string {
...
// It is only allowed when executing a group-by query with one field.
func (cdgb *CoinDescriptionGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{coindescription.Label}
	default:
		err = fmt.Errorf("ent: CoinDescriptionGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (cdgb *CoinDescriptionGroupBy) StringX(ctx context.Context) string {
...
// It is only allowed when executing a group-by query with one field.
func (cdgb *CoinDescriptionGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cdgb.fields) > 1 {
		return nil, errors.New("ent: CoinDescriptionGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cdgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cdgb *CoinDescriptionGroupBy) IntsX(ctx context.Context) []int {
	v, err := cdgb.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (cdgb *CoinDescriptionGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{coindescription.Label}
	default:
		err = fmt.Errorf("ent: CoinDescriptionGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (cdgb *CoinDescriptionGroupBy) IntX(ctx context.Context) int {
	v, err := cdgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (cdgb *CoinDescriptionGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cdgb.fields) > 1 {
		return nil, errors.New("ent: CoinDescriptionGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cdgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cdgb *CoinDescriptionGroupBy) Float64sX(ctx context.Context) []float64 {
...
// It is only allowed when executing a group-by query with one field.
func (cdgb *CoinDescriptionGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{coindescription.Label}
	default:
		err = fmt.Errorf("ent: CoinDescriptionGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (cdgb *CoinDescriptionGroupBy) Float64X(ctx context.Context) float64 {
...
// It is only allowed when executing a group-by query with one field.
func (cdgb *CoinDescriptionGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cdgb.fields) > 1 {
		return nil, errors.New("ent: CoinDescriptionGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cdgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cdgb *CoinDescriptionGroupBy) BoolsX(ctx context.Context) []bool {
...
// It is only allowed when executing a group-by query with one field.
func (cdgb *CoinDescriptionGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{coindescription.Label}
	default:
		err = fmt.Errorf("ent: CoinDescriptionGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (cdgb *CoinDescriptionGroupBy) BoolX(ctx context.Context) bool {
	v, err := cdgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
// ScanX is like Scan, but panics if an error occurs.
func (cds *CoinDescriptionSelect) ScanX(ctx context.Context, v interface{}) {
...
func (cds *CoinDescriptionSelect) Strings(ctx context.Context) ([]string, error) {
	if len(cds.fields) > 1 {
		return nil, errors.New("ent: CoinDescriptionSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cds.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (cds *CoinDescriptionSelect) StringsX(ctx context.Context) []string {
...
func (cds *CoinDescriptionSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{coindescription.Label}
	default:
		err = fmt.Errorf("ent: CoinDescriptionSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (cds *CoinDescriptionSelect) StringX(ctx context.Context) string {
...
func (cds *CoinDescriptionSelect) Ints(ctx context.Context) ([]int, error) {
	if len(cds.fields) > 1 {
		return nil, errors.New("ent: CoinDescriptionSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cds.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (cds *CoinDescriptionSelect) IntsX(ctx context.Context) []int {
	v, err := cds.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (cds *CoinDescriptionSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{coindescription.Label}
	default:
		err = fmt.Errorf("ent: CoinDescriptionSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (cds *CoinDescriptionSelect) IntX(ctx context.Context) int {
	v, err := cds.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (cds *CoinDescriptionSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cds.fields) > 1 {
		return nil, errors.New("ent: CoinDescriptionSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cds.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (cds *CoinDescriptionSelect) Float64sX(ctx context.Context) []float64 {
...
func (cds *CoinDescriptionSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{coindescription.Label}
	default:
		err = fmt.Errorf("ent: CoinDescriptionSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (cds *CoinDescriptionSelect) Float64X(ctx context.Context) float64 {
...
func (cds *CoinDescriptionSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cds.fields) > 1 {
		return nil, errors.New("ent: CoinDescriptionSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cds.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (cds *CoinDescriptionSelect) BoolsX(ctx context.Context) []bool {
	v, err := cds.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
func (cds *CoinDescriptionSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{coindescription.Label}
	default:
		err = fmt.Errorf("ent: CoinDescriptionSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (cds *CoinDescriptionSelect) BoolX(ctx context.Context) bool {
	v, err := cds.Bool(ctx)
	if err != nil {
		panic(err)
	}
