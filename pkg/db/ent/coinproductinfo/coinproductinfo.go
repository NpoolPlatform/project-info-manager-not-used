...
const (
	// Label holds the string label denoting the coinproductinfo type in the database.
	Label = "coin_product_info"
	...
	// Table holds the table name of the coinproductinfo in the database.
	Table = "coin_product_infos"
)

// Columns holds all SQL columns for coinproductinfo fields.
var Columns = []string{
	FieldID,
	FieldCreateAt,
	FieldUpdateAt,
